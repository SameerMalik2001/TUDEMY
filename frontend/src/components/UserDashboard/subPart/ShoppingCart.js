...
function ShoppingCart() {
  ...
  return (
    <div className='yourCourse_container'>
      <p style={{fontSize:25, marginTop:20}}>Shopping Cart</p>
      <div className="createdCourse_contaier">
        { 
          createdCourse?.carts?.map(C=>{
        ...
        {
          createdCourse?.carts?.length === 0 && <p style={{textAlign:'center', marginTop:10, fontSize:18}}>No Course Added</p>
        }
