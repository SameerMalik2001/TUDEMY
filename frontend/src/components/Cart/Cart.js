      ...
      <div onMouseEnter={()=>{out(".dropdown1"); out(".dropdown2"); out('.dropdown')}} className="main_cart_container">
        ...
        <div className="other_container">
          <div className="cart_course">
            ...
            {!courseLoading &&
              cart?.carts.map((C)=>{
                return <div onClick={()=>window.location.href = '/course/'+C?.course[0]?._id} className="cart_course_box">
                    ...
                    <div className="other_buttons">
                      <button onClick={(e)=>deleteToCart(e, C?.courseId)} className="remove_cart_button">Remove</button>
                      <button onClick={(e)=>addToWishlist(e, C?.courseId)} className="add_cart_button">Add to Wishlist</button>
                    </div>
                  </div>
              })
            }
            ...
            {
              !courseLoading && cart?.carts.length === 0 && <p>Cart is empty...</p>
            }
          ...
          <div className="purchased_box">
            ...
            <div onClick={()=>payment(cart?.real_price)} className="checkout_btn">
              <p>Checkout</p>
            </div>
          </div>
        </div>
